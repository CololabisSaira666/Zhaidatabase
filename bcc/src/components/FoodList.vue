<template>
  ...
  <div style="clear: both;"></div>
    <div style="align-items: center;">
      <button class="page_button" @click="topPage">首 页</button>
      <button class="page_button" @click="prevPage">上一页</button>
      <button class="page_button" @click="empty">{{this.rank}}</button>
      <button class="page_button" @click="nextPage">下一页</button>
      <button class="page_button" @click="endPage">尾 页</button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    endPage() {
      this.rank = Math.ceil(this.foods.length / this.num);
      this.$forceUpdate;
    },
    isVisible(idx) {
